...
router.post("/", async (req, res) => {
    try {
        ...
        res.status(200).send({ user: { name: user.firstName, surname: user.lastName, email: user.email, profileImage: user.profileImage }, token, message: "Logged in successfully" });
    } catch (error) {
